...
class Inventario:
  ...
  def print_header(self, subheader):
    clear()
    print(f"==========================================================================")
    print(f"                                INVENTÁRIO                                ")
    print(f"==========================================================================")
