...
ALTER TABLE area
ADD COLUMN area_norte INT,
ADD COLUMN area_sul INT,
ADD COLUMN area_leste INT,
ADD COLUMN area_oeste INT,
ADD FOREIGN KEY (area_norte) REFERENCES area(id),
ADD FOREIGN KEY (area_sul) REFERENCES area(id),
ADD FOREIGN KEY (area_leste) REFERENCES area(id),
ADD FOREIGN KEY (area_oeste) REFERENCES area(id);
